...
class ElbManager:
    ...
    def _get_instance_lbs(self, ec2_elbs=None):
        ...
        try:
            elb = connect_to_aws(fcu_boto.ec2.elb, self.region, **self.aws_connect_params)
    ...
    def _get_auto_scaling_group_lbs(self):
        ...
        try:
           asg = connect_to_aws(fcu_boto.ec2.autoscale, self.region, **self.aws_connect_params)
        except (fcu_boto.exception.NoAuthHandlerFound, AnsibleAWSError) as e:
            self.module.fail_json(msg=str(e))
    ...
    def _get_instance(self):
        """Returns a fcu_boto.ec2.InstanceObject for self.instance_id"""
        try:
            ec2 = connect_to_aws(fcu_boto.ec2, self.region, **self.aws_connect_params)
        except (fcu_boto.exception.NoAuthHandlerFound, AnsibleAWSError) as e:
            self.module.fail_json(msg=str(e))
