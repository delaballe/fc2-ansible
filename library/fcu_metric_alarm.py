...
try:
    import fcu_boto.ec2.cloudwatch
    from fcu_boto.ec2.cloudwatch import CloudWatchConnection, MetricAlarm
...
def main():
    ...
    if region:
        try:
            connection = connect_to_aws(fcu_boto.ec2.cloudwatch, region, **aws_connect_params)
