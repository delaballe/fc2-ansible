...
description:
    - Create or terminates AWS virtual private clouds.  This module has a dependency on python-fcu_boto.
version_added: "1.4"
options:
  cidr_block:
    description:
...
def main():
    ...
    if region:
        try:
            vpc_conn = connect_to_aws(fcu_boto.vpc, region, **aws_connect_kwargs)
