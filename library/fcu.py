...
---
module: fcu
short_description: create, terminate, start or stop an instance in fcu
description:
    - Creates or terminates fcu instances.
...
options:
  ...
  region:
    version_added: "1.2"
    description:
      - The AWS region to use.  Must be specified if fcu_url is not used. If not specified then the value of the fcu_REGION environment variable, if any, is used. See U(http://docs.aws.amazon.com/general/latest/gr/rande.html#fcu_region)
    required: false
    default: null
    aliases: [ 'aws_region', 'fcu_region' ]
  zone:
    version_added: "1.2"
    description:
  ...
  user_data:
    version_added: "0.9"
    description:
      - opaque blob of data which is made available to the fcu instance
    required: false
    default: null
    aliases: []
  instance_tags:
